...
function queryAllByRole(container, role, {
    ...
    return Array.from(container.querySelectorAll( // Only query elements that can be matched by the following filters
        makeRoleSelector(role))).filter(node => {
            ...
            if (selected !== undefined) {
                return selected === (0, helpers.computeAriaSelected)(element);
            }

            if (checked !== undefined) {
                return checked === (0, helpers.computeAriaChecked)(element);
            }

            if (pressed !== undefined) {
                return pressed === (0, helpers.computeAriaPressed)(element);
            }

            if (current !== undefined) {
                return current === (0, helpers.computeAriaCurrent)(element);
            }

            if (expanded !== undefined) {
                return expanded === (0, helpers.computeAriaExpanded)(element);
            }

            if (level !== undefined) {
                return level === (0, helpers.computeHeadingLevel)(element);
...
exports.buildElementRoleList = buildElementRoleList;
exports.getRoles = getRoles;
exports.makeRoleSelector = makeRoleSelector;
